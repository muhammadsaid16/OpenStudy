                  ...
                  {!isFlipped ? (
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-2 sm:grid-cols-4 sm:gap-3">
                      {RATING_BUTTONS.map((btn) => (
                        <button key={btn.value} onClick={() => handleRate(btn.value)} disabled={reviewing} className={`min-h-[48px] rounded-xl border px-3 py-3 text-sm font-bold transition-colors disabled:opacity-50 ${btn.color}`}>
