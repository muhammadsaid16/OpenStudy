  ...
  return (
    ...
    >
      <span className="relative flex h-2.5 w-2.5" aria-hidden>
        {!pomo.paused && <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-primary-container opacity-60" />}
        <span className="relative inline-flex h-2.5 w-2.5 rounded-full bg-primary-container" />
      </span>
      <Timer size={13} className="text-primary" aria-hidden />
